...
install_devops() {
    ...
    prompt -i "Installing Docker"

    scripts_install ca-certificates curl gnupg
    ...
    scripts_update
    scripts_install docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin

    prompt -i "Installed Docker"

    prompt -i "Installing AWS CLI"
    ...
    prompt -i "Installing Terraform"
    scripts_install gnupg software-properties-common
    ...
    scripts_update
    scripts_install terraform

    prompt -i "Installed Terraform"
